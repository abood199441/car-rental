package com.example.abdelrahmanapps.carrentaltrial.utils;
...
public class Constants {
    ...
    public static final int REQUEST_PERMISSION_LOCATION =120;
    public static final int REQUEST_PERMISSIONS_STORAGE_LOCATION =15;
    public static final int PLACE_PICKER_REQUEST = 20;
    public static final String TAG ="Phone Credentials";
    public static final int REQUEST_IMAGE_LOCAL=155;
